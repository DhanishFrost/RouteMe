...
import './updatebooking.dart';

class BookingDetailsInProgress extends StatefulWidget {
  const BookingDetailsInProgress(
      {Key? key,
      required this.city,
  ...
  @override
  State<BookingDetailsInProgress> createState() =>
      _BookingDetailsInProgressState();
}

class _BookingDetailsInProgressState extends State<BookingDetailsInProgress> {
    ...
    try {
      ...
      if (user != null) {
        ...
        await FirebaseFirestore.instance
            ...
            .doc(userEmail)
            .update({
          widget.hotelName: FieldValue.delete(),
        });
                ...
                children: [
                  ElevatedButton(
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) => UpdateBooking(
                                ...
                                noOfGuests: int.parse(widget.noOfGuests.toString()),
                                noOfRooms: int.parse(widget.noOfRooms.toString()),
                      ...
                      style: ElevatedButton.styleFrom(
                        ...
                        minimumSize:
                            Size(screenWidth * 0.44, screenHeight * 0.07),
                      )),
